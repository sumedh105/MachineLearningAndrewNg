...
valueOfN = n;				% This is a debug comment
...
valueOfNum_Labels = num_labels;		% This is a debug comment
...
for c = 1:num_labels,
	...
	valueOfThetaPrime = theta';			% This is a debug comment
	all_theta(c, :) = theta';
end
valueOfAllTheta = all_theta;				% This is a debug comment
